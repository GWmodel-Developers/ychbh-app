// 代履行催告通知书
function NotiperforRemin(param0, param1, param2) {
  this.documentID = null;
	this.objectName = null;
	this.noteTime = Date.today().toString("yyyy-MM-dd");
	this.noteName = null;
  ...
  this.noteTime = this.noteTime.replace(/[年月]/g, "-").replace(/[日]/g, "");
...
NotiperforRemin.prototype.domMap = [
   {
    key: "documentID",
    name: "宜黄综执",
    type: "span",
