// 行政处罚强制执行申请书
function AdministrativePunishmentEnforcementApplication(param0, param1, param2, param3, param4) {
...
AdministrativePunishmentEnforcementApplication.prototype.domMap = [
   {
    key: "documentID",
    name: "宜黄综执号",
    type: "span",
